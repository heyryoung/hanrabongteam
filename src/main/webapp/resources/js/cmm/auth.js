...
auth = (()=>{
	...
	let onCreate =()=>{
		...
		'            <label for="firstName">CNum</label>'+
		'            <input type="text" class="form-control" id="cnum" placeholder="" value="" required="">'+
		'            <div class="invalid-feedback">'+
		'              Valid first name is required.'+
		'            </div>'+
		'          </div>'+
		'          <div class="col-md-6 mb-3">'+
		'            <label for="lastName">CPw</label>'+
